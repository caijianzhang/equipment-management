package com.ronnie.common.service;
...
import com.ronnie.util.UUIDUtil;
    ...
    public Result<V> save(V entityVo) {
        ...
        try {
            ...
            for (Field field : entity.getClass().getDeclaredFields()) {
                ...
                if(isInsert && "gmtCreated".equals(fieldName) && StringUtils.isEmpty(fieldValue)){
                ...
                if("gmtModified".equals(fieldName) && StringUtils.isEmpty(fieldValue)){
                    //先赋值给fieldValue，以免后续进行copy对象判断属性是否为忽略属性是出错
                    fieldValue = new Date();
