...
public class EmployeeServiceImpl extends CommonServiceImpl<EmployeeVo, Employee, Long> implements EmployeeService {
    ...
    @Override
    public Result<PageInfo<EmployeeVo>> page(EmployeeVo entityVo, Long departmentId) {
        //根据实体、Vo直接拼接全部SQL
        Map<String, Object> conditions = new HashMap<>(2);
        conditions.put("department_id", departmentId);
        StringBuilder sql = SqlUtil.joinSqlByEntityAndVo(Employee.class, entityVo, conditions);
